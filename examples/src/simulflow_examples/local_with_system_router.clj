(ns simulflow-examples.local-with-system-router
  ...
  (:require
   ...
   [simulflow.processors.system-frame-router :as system-router :refer [system-frame-router-process]]
