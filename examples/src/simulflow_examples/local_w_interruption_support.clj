(ns simulflow-examples.local-w-interruption-support
  "This example demonstrates interruption handling​ When the LLM is responding to
  the user, if the user says something, the current playback is interrupted and
  processors that have interruption support drop their activity until the user stops speaking."
  (:require
